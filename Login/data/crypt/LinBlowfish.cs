...
{
	public class LinBlowfish
	{
		private static int[] P = { 0x243F6A88, -2052912941, 0x13198A2E, 0x3707344,
				-1542899678, 0x299F31D0, 0x82EFA98, -330404727, 0x452821E6,
				0x38D01377, -1101764913, 0x34E90C6C, -1062458953, -914599715,
				0x3F84D5B5, -1253635817, -1843997223, -1988494565 };
	
		private static long[][] S = {
				new long[] { 0x0D1310BA6L, 0x98DFB5ACL, 0x2FFD72DBL, 0x0D01ADFB7L,
				...
				new long[] { 0x4B7A70E9L, 0x0B5B32944L, 0x0DB75092EL, 0x0C4192623L,
				...
				new long[] { 0x0E93D5A68L, 0x948140F7L, 0x0F64C261CL, 0x94692934L,
				...
				new long[] { 0x3A39CE37L, 0x0D3FAF5CFL, 0x0ABC27737L, 0x5AC52D1BL,
		...
		private static int SSIZE = 256; // S.length;
		...
		internal void Blowfish_decrypt(long L, long R)
		{
			long temp, xL = L, xR = R;
		...
		public static long[] GetSeeds(long[] keys)
		{
			...
			long rotrParam = ULong32.FromLong64(keys[0] ^ -1674521287);
		...
		public static int _rotr(int value_ren, int n)
		{
			return ((int) (((uint) value_ren) >> n)) | (value_ren << (32 - n));
		}
